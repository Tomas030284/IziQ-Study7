...
async function getCategories() {
  const response = await axios
    .get("https://izi-q-study7.vercel.app/api/categories")
    .then((res) => res.data);
...
async function getSubcategoriesByCategoryId(categoryId) {
  if (!categoryId) {
    const response = await axios
      .get("https://izi-q-study7.vercel.app/api/subcategories/")
      .then((res) => res.data);

    return response;
  } else {
    const response = await axios
            .get(`https://izi-q-study7.vercel.app/api/subcategories/category/${categoryId}`
      )
      .then((res) => res.data);
